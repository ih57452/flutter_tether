...
class SearchStreamNotifierSettings<TModel extends TetherModel<TModel>>
  ...
  final SupabaseSelectBuilderBase selectArgs; // Stable (e.g., a constant or from a provider)
  final TModel Function(Map<String, dynamic> json) fromJsonFactory; // Stable (e.g., static method)
  ...
  QueryBuilderFactory<TModel> get queryBuilderFactory {
    return () {
      var q =
          clientManager.query().select(selectArgs);
    ...
    try {
      ...
      final items =
          await query
              ...
              .range(0, _currentSettings.pageSize)
              .remoteOnly();
    ...
    try {
      ...
      final newItems =
          await query
              .textSearch(_currentSettings.searchColumn, terms)
              .range(
                nextPage * _currentSettings.pageSize,
                (nextPage + 1) * _currentSettings.pageSize - 1,
              )
              .remoteOnly();
