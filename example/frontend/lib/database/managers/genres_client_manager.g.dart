...
final genresSearchFeedProvider = StreamNotifierProvider.autoDispose.family<
  SearchStreamNotifier<GenreModel>, // NotifierT: Your notifier class
...
>(() {
  ...
  return SearchStreamNotifier<GenreModel>();
});
