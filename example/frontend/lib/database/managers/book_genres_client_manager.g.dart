...
final bookGenresSearchFeedProvider = StreamNotifierProvider.autoDispose.family<
  SearchStreamNotifier<BookGenreModel>, // NotifierT: Your notifier class
...
>(() {
  ...
  return SearchStreamNotifier<BookGenreModel>();
});
