...
final bookstoresSearchFeedProvider = StreamNotifierProvider.autoDispose.family<
  SearchStreamNotifier<BookstoreModel>, // NotifierT: Your notifier class
...
>(() {
  ...
  return SearchStreamNotifier<BookstoreModel>();
});
